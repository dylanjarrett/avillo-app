      ...
      <div className="space-y-8 pb-16">
        ...
        <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold">
              Hey {firstName}, here&apos;s your Avillo plan.
            </h1>
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-xs text-[#AAB4C0]">
                  ...
                  Avillo with top agents. Pricing for your cohort will be
          ...
          <div className="rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_top,_rgba(37,99,235,0.35)_0,_#050814_55%)] p-6 shadow-[0_0_26px_rgba(0,0,0,0.7)]">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-3">
              <UsageMetric
                ...
                value="0"
                helper="Listing + seller flows generated in Avillo."
              />
              <UsageMetric
                label="Hours saved"
                value="0.0"
            ...
            <div className="mt-5 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-[11px] text-[#E5E7EB]">
              ...
              <p className="mt-1">
                ...
                Intelligence and Avillo will handle MLS copy, bullets,
        ...
        <section className="space-y-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-1 max-w-xl text-xs text-[#AAB4C0]">
                Avillo is designed so a solo agent can get leverage on day
            ...
            <div className="flex flex-col items-start gap-2 sm:items-end">
              ...
              <p className="text-[11px] text-[#9CA3AF]">
                {isAnnual
                  ? "Billed yearly · Best value for agents committed to Avillo."
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            ...
            {/* Avillo Pro (Stripe checkout wired) */}
            <PlanCard
              label="Coming soon"
            ...
            <PlanCard
              ...
              name="Enterprise"
              tagline="Roll Avillo out across your entire organization."
        ...
        <section className="grid gap-5 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-emerald-500/30 bg-[radial-gradient(circle_at_top,_rgba(16,185,129,0.4)_0,_#020617_55%)] p-6 text-xs text-[#D1FAE5] shadow-[0_0_30px_rgba(16,185,129,0.4)]">
            ...
            <p className="mt-2 text-[11px] text-[#A7F3D0]">
              Avillo is built for regulated, relationship-driven
